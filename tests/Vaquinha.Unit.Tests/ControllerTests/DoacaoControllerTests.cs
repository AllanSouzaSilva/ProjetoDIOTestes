...
namespace Vaquinha.Unit.Tests.ControllerTests
{
                                        ...
                                        IClassFixture<CartaoCreditoFixture>
    {
        ...
        private Mock<IMapper> _mapper; //Vai simular o comportamento de uma classe
        ...
        public void DoacaoController_Adicionar_RetornaDadosComSucesso()
        {
            ...
            ((RedirectToActionResult)retorno).ActionName.Should().Be("Index"); //Verificação se action foi para index/home
